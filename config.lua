...
Config.Performancetuning            = true
Config.JobPrice                     = 2    --Teilt den Fahrzeugpreis mit 2 durch 2. Somit sind alle Tuningteile um die Hälfte günstiger
Config.SpawnServerside              = true --Serverside Spawning Refresher

Config.Zones                        = {

	ls1 = {
		Pos    = { x = -212.38, y = -1323.92, z = 30.57 },
	...
	ls3 = {
		Pos    = { x = 1178.04, y = 2638.21, z = 37.32 },
		Size   = { x = 3.0, y = 3.0, z = 0.2 },
		Color  = { r = 204, g = 204, b = 0 },
		Marker = 1,
		Name   = TranslateCap('blip_name'),
	...
	ls4 = {
		Pos    = { x = 107.99, y = 6625.39, z = 30.89 },
		Size   = { x = 3.0, y = 3.0, z = 0.2 },
		Color  = { r = 204, g = 204, b = 0 },
		Marker = 1,
		Name   = TranslateCap('blip_name'),
	...
	ls6 = {
		Pos    = { x = -352.0804, y = -162.6521, z = 38.0259 },
		Size   = { x = 3.0, y = 3.0, z = 0.2 },
		Color  = { r = 204, g = 204, b = 0 },
		Marker = 1,
		Name   = TranslateCap('blip_name'),
	...
	ls7 = {
		Pos    = { x = -1366.4336, y = -3218.7131, z = 13.9451 },
		Size   = { x = 3.0, y = 3.0, z = 0.2 },
		Color  = { r = 204, g = 204, b = 0 },
		Marker = 1,
		Name   = TranslateCap('blip_name'),
...
Config.Colors                       = {
	...
	{ label = TranslateCap('chameleon'), value = 'chameleon' }
}
...
function GetColors(color)
	...
	elseif color == 'chameleon' then
		colors = {
			{ index = 223, label = ('Cham Schwarz/Weiß') },
			{ index = 224, label = ('Cham Gelb/Blau') },
			{ index = 225, label = ('Cham Pink/Blau') },
			{ index = 226, label = ('Cham Grün') },
			{ index = 227, label = ('Cham Pink/Hellblau') },
			{ index = 228, label = ('Cham Pink/Gelb') },
			{ index = 229, label = ('Cham Blau/Gelb') },
			{ index = 230, label = ('Cham Gelb/Pink') },
			{ index = 231, label = ('Cham Gum') },
			{ index = 232, label = ('Cham Rainbow') },
			{ index = 233, label = ('Cham Orange/Pink') },
			{ index = 234, label = ('Cham Blau/Grün') },
			{ index = 235, label = ('Cham Blau/Rot') },
			{ index = 236, label = ('Cham Rot/Hellblau') },
			{ index = 237, label = ('Cham Grün/Rot') },
			{ index = 238, label = ('Cham Rainbow 2') },
			{ index = 239, label = ('Cham Rot') },
			{ index = 240, label = ('Cham Violett') },
			{ index = 241, label = ('Cham Grün3') },
			{ index = 242, label = ('Cham Blau') },
		}
	end
	return colors
end
...
Config.Menus = {
	...
	main = {
		...
		xenonColor        = TranslateCap('headlights2'),
	...
	modSuspension = {
		...
		parent = 'upgrades',
		modType = 15,
		price = { 3.72, 7.44, 14.88, 29.77, 40.2, 53, 3 }
	},
	modArmor = {
	...
	modFrontWheelsTypes = {
		...
		modFrontWheelsType8  = TranslateCap('bennys'),
		modFrontWheelsType9  = TranslateCap('bennys2'),
		--modFrontWheelsType10 = TranslateCap('dragster'),
		modFrontWheelsType11 = TranslateCap('street'),
	},
	modFrontWheelsType0 = {
	...
	resprays = {
		...
		interiorRespray = "Interior",
		dashboardRespray = "Dashboard",
	},
	primaryRespray = {
	...
	interiorRespray = {
		label = "Interior Lackierungen",
		parent = 'resprays',
	}, --NEU
	dashboardRespray = {
		label = "Dashboard Lackierungen",
		parent = 'resprays',
	},
	color1 = {
		label = TranslateCap('primary'),
	...
	xenonColor = {
		label = TranslateCap('headlights2'),
		parent = 'main',
		modType = 'xenonColor',
		price = 3.72
	},
